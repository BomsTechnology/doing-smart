      ...
      <div class="flex flex-col justify-start">
        ...
        <ul class="lg:text-lg text-sm space-y-4 px-8 mt-4">
          <li class="flex space-x-2 items-center">
            ...
            <span>Marketing classique & Digitale</span>
          </li>
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
            <span>Physcologie du client </span>
          </li>
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
            <span>L’art de la vente</span>
          </li>
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
          ...
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
            <span>Création d’une ligne éditoriale</span>
          </li>
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
            <span>Le copywriting</span>
          </li>
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
            <span>Les outils du community Manager</span>
          </li>
          <li class="flex space-x-2 items-center">
            <CheckCircleIcon class="lg:h-5 lg:w-5 h-3 w-3 text-[#193334]" />
            <span>La publicité Facebook</span>
          </li>
        </ul>
      </div>
    </div>
