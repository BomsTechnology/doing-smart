...
import { EnvelopeIcon, MapPinIcon, ShareIcon } from "@heroicons/vue/24/outline";
import { PhoneIcon } from "@heroicons/vue/24/solid";
</script>

<template>
  <div
    class="w-full bg-[#193334] text-white xl:px-48 px-4 mt-52 md:pt-44 pt-80 relative"
  >
    <div
      class="p-4 md:p-10 xl:w-3/4 w-[92%] bg-smart-blue md:mt-0 mt-8 rounded-md absolute -top-44 z-10 flex flex-col-reverse items-center md:flex-row"
    >
    ...
    <footer class="w-full text-white relative">
      <div class="grid md:grid-cols-2 py-8 grid-cols-1 gap-8 lg:grid-cols-4">
        <div>
          <h1 class="flex space-x-2 items-center font-bold upppercase text-lg">
            <PhoneIcon class="w-5 h-5" />
            <span>Téléphone</span>
          </h1>
          <h2 class="mt-3">237 657 52 58 12</h2>
        </div>
        <div>
          <h1 class="flex space-x-2 items-center font-bold upppercase text-lg">
          ...
          <h2 class="mt-3">contactdoingsmart@gmail.com</h2>
        </div>
        <div>
          <h1 class="flex space-x-2 items-center font-bold upppercase text-lg">
          ...
          <h2 class="mt-3">Ndokoti, Base Ketch</h2>
        </div>
        <div>
          <h1 class="flex space-x-2 items-center font-bold upppercase text-lg">
          ...
          <div class="flex mt-3 space-x-2 items-center">
            <a
              href="#"
